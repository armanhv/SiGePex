...
echo '<SELECT onClick="buscarCliente();obtenerTelefonosCliente() " NAME="cbxCliente" id="cbxCliente" SIZE=1>';
...
foreach ($listaClientes as $currentCliente) {
    ...
    echo '<option value=' . $idCliente  . '>' .$currentCliente->nombreCliente .'</option>';
}
